<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chemsearch.aspx.cs" Inherits="TechColaApp.chemsearch" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#origin_autocomplete").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "chemsearch.aspx/getChemicalName",
                        dataType: "json",
        ...
        $(function () {
            $("#btnClear").click(function () {
                $.ajax({
                    url: "chemsearch.aspx/clearResults",
                    success: function () {
                        var scrollSpeed = 1000;
        ...
        $(function () {
            $("#hrefddd").click(function () {
                ...
                //alert(x);
                $.ajax({
                    url: "chemsearch.aspx/getChemicalData",
                    dataType: "json",
                    data: "{ id: '" + x + "' }",
                    type: "POST",
                    cache: false,
...
<body>
    ...
    <section id="banner">
				<header>
                    ...
                    <a href="http://healthawarenessplatform.azurewebsites.net/Content/index.html"><b>HOME</b></a>
    ...
    <section id="footer">
			<div class="copyright">
				<ul class="menu">
                     <li> <a href="http://healthawarenessplatform.azurewebsites.net/Content/index.html"><b>Back to HOME</b></a> </li> <br />
