...
{
    public class HappyTweetsRepository : IRepository
    {
        ...
        public const string DEFAULT_TABLE_NAME = "HappyTweets";
        ...
        public HappyTweetsRepository(string tableName, string partKey)
            : this(new HappyConfigManager(), tableName, partKey)
        {
        }


        public HappyTweetsRepository(IConfigManager configMgr,
        ...
        public void InsertHappyTweetDetails(HappyTweet device)
        {
            TableResult result;
        ...
        public List<HappyTweet> GetAll(string rowKey)
        {
            List<HappyTweet> dEntList = new List<HappyTweet>();
            HappyTweet dEnt = null;

            TableQuery<HappyTweet> rangeQuery = new TableQuery<HappyTweet>().Where(
            ...
            foreach (HappyTweet e in _table.ExecuteQuery(rangeQuery))
            {
                char[] delim = { ',' };
                ...
                dEnt.TweetMessage = (e.TweetMessage == null) ? DEFAULT_STR_VALUE : e.TweetMessage;
                if (dEnt.roles != null)
                {
        ...
        public List<HappyTweet> GetAllForRole(string role)
        {
            List<HappyTweet> dEntList = new List<HappyTweet>();
            HappyTweet dEnt;
    ...
    public class HappyTweet : TableEntity
    {
        ...
        public HappyTweet(string name, string tweetmsg, string desc)
        {
